...
num_leading_zeros = 3
num_classes = 49
result_directory = './test-model-for-thesis-result/'
...
shape = (224, 224)
num_images = 0
test_directory = './test-model-for-thesis/'
for folder_name in os.listdir(test_directory):
    ...
    for filename in os.listdir(os.path.join(test_directory, folder_name)):
        ...
        if original_img is not None:
            ...
            image_name = '[{}]{}.png'.format(normalized_predict_confidence, str(image_number).zfill(num_leading_zeros))
